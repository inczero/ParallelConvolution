...
namespace TaskSolution {
    public static class Slicer {
        ...
        public static List<BitmapSlice> RipApartFramedWithOverlapList(Bitmap image, int pieces, int overlap) {
            ConcurrentBag<BitmapSlice> bag = RipApartFramedWithOverlap(image, pieces, overlap);
