...
namespace ParallelConvolution {
    public static class FilterUtils {
        ...
        // DrawBorder method draws a borderSize wide borderColor colored band around the input image
        public static Bitmap DrawBorder(Bitmap image, int borderSize, Color borderColor) {
            ...
            using (Graphics g = Graphics.FromImage(imageWithBorder)) {
                // set these to mitigate quality deterioration
        ...
        // calculatePixelChannel method checks if channel value is in the correct intervall
